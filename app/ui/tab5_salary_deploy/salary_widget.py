...
# Định nghĩa 4 nhóm file nguồn chính
...
class SalaryDeployWidget(QWidget):
    ...
    def _build_config_page(self) -> QWidget:
        ...
        hint = QLabel(
            ...
            "Khi đủ 4 file, nhấn «Tiếp tục» để sang màn hình triển khai."
        )
        ...
        config_group = QGroupBox("⚙️ Cấu hình 4 file liên kết nguồn")
    ...
    def _is_source_config_complete(self) -> tuple:
        """Kiểm tra đã chọn đủ và hợp lệ 4 file nguồn chưa."""
        missing = []
        for defn in SOURCE_FILE_DEFINITIONS:
            key = defn["key"]
    ...
    def _go_to_deploy_page(self):
        ...
        if not complete:
            QMessageBox.warning(
                ...
                "Vui lòng chọn đủ 4 file Excel nguồn:\n\n"
