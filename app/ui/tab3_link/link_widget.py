...
from app.utils.paths import get_json_data_path, get_split_excel_path
...
class LinkExcelWidget(QWidget):
    ...
    def __init__(self):
        ...
        self.integration_thread = None  # ✅ Khởi tạo thread attribute để tránh conflict với QWidget.thread()
        self.setStyleSheet("""
    ...
    def start_processing(self):
        # Tránh chạy đè luồng nếu đang xử lý
        ...
        self.integration_thread = IntegrationThread(json_root, excel_dir, env_pwd, single_dept)
