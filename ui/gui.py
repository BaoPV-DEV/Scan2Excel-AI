...
from ui.tab0_template_config.column_config_widget import ColumnConfigWidget
...
class MainWindow(QMainWindow):
    ...
    Quản lý các tab chức năng: Cấu hình template, Tách file, Scan ảnh, và Tích hợp Excel.
    """
    def __init__(self):
        super().__init__()
